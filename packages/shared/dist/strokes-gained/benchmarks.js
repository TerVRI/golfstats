...
export const TEE_SHOT_BENCHMARKS = {
    100: 2.92,
    125: 2.99,
    150: 3.08,
    175: 3.18,
...
export const FAIRWAY_BENCHMARKS = {
    25: 2.40,
    50: 2.60,
    75: 2.72,
    100: 2.87,
...
export const BUNKER_BENCHMARKS = {
    10: 2.43,
    20: 2.53,
    30: 2.68,
    40: 2.83,
...
export const RECOVERY_BENCHMARKS = {
    25: 2.77,
    50: 2.96,
    75: 3.12,
    100: 3.24,
...
export const PUTTING_BENCHMARKS = {
    1: 1.001,
    2: 1.009,
    3: 1.044,
    4: 1.115,
...
export const ON_GREEN_BENCHMARKS = {
    5: 1.26,
    10: 1.55,
    15: 1.72,
    20: 1.88,
 ...
 */
export function interpolate(benchmarks, distance) {
    const distances = Object.keys(benchmarks)
        .map(Number)
        .sort((a, b) => a - b);
    // Handle edge cases
    if (distance <= distances[0])
        return benchmarks[distances[0]];
