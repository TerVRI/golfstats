...
#ifndef GOLFSTATSWATCH_SWIFT_H
#define GOLFSTATSWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GolfStatsWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC14GolfStatsWatch10GPSManager")
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC14GolfStatsWatch12RoundManager")
@interface RoundManager : NSObject <WCSessionDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
